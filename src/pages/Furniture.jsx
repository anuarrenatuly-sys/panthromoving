...
furnitureServicePage: "Furniture Moving",

heroTitle: "Furniture Transportation",

heroText:
"We safely transport furniture of any size with professional handling and protection.",

feature1: "Sofa Moving",
feature2: "Bed Transport",
feature3: "Setup",
feature4: "Delivery",

whyTitle: "Why Choose Our Furniture Service",

whyText:
"Our movers carefully transport and protect your furniture using professional equipment and secure handling.",
...
careText: "Furniture Care",
careTitle: "How We Protect Furniture",

care1Title: "Soft Protection",
care1Text: "We use premium blankets and wrapping materials for furniture safety.",

care2Title: "Secure Transport",
care2Text: "Every furniture item is fixed securely during transportation.",

care3Title: "Careful Handling",
care3Text: "Our movers carefully load and unload furniture without damage.",
},
...
furnitureServicePage: "Перевозка мебели",

heroTitle: "Перевозка мебели",

heroText:
"Мы безопасно перевозим мебель любых размеров с профессиональной защитой и аккуратной доставкой.",
...
whyTitle: "Почему выбирают нашу перевозку",

whyText:
"Наши специалисты аккуратно перевозят и защищают мебель с использованием профессионального оборудования.",
...
careText: "Защита мебели",
careTitle: "Как мы защищаем мебель",

care1Title: "Мягкая защита",
care1Text: "Мы используем защитные материалы и одеяла для безопасности мебели.",

care2Title: "Надёжная перевозка",
care2Text: "Каждый предмет мебели фиксируется во время транспортировки.",

care3Title: "Аккуратная работа",
care3Text: "Наши специалисты аккуратно загружают и разгружают мебель.",
}
...
{translations[lang].furnitureServicePage}
</p>
...
<Sofa size={28} className="text-blue-400" />
</div>
...
<div className="w-16 h-16 rounded-full bg-gradient-to-br from-blue-500/20 to-purple-500/20 border border-white/10 backdrop-blur-xl flex items-center justify-center">
<BedDouble size={28} className="text-blue-400" />
</div>
...
<div className="w-16 h-16 rounded-full bg-gradient-to-br from-blue-500/20 to-purple-500/20 border border-white/10 backdrop-blur-xl flex items-center justify-center">
<Lamp size={28} className="text-blue-400" />
</div>
...
<div className="w-16 h-16 rounded-full bg-gradient-to-br from-blue-500/20 to-purple-500/20 border border-white/10 backdrop-blur-xl flex items-center justify-center">
<Armchair size={28} className="text-blue-400" />
</div>
...
{translations[lang].careText}
</p>

<h2 className="text-5xl font-black">
{translations[lang].careTitle}
</h2>
...
{translations[lang].care1Title}
</h3>

<p className="text-gray-400 leading-relaxed">
{translations[lang].care1Text}
</p>
...
<h3 className="text-2xl font-black mb-4">
{translations[lang].care2Title}
</h3>

<p className="text-gray-400 leading-relaxed">
{translations[lang].care2Text}
</p>
...
<h3 className="text-2xl font-black mb-4">
{translations[lang].care3Title}
</h3>

<p className="text-gray-400 leading-relaxed">
{translations[lang].care3Text}
</p>
