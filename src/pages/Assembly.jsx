...
assemblyServicePage: "Assembly Service",

heroTitle: "Furniture Assembly & Disassembly",

heroText:
"Our team professionally assembles and disassembles furniture for safe and efficient moving.",

feature1: "Furniture Disassembly",
feature2: "Safe Reassembly",
feature3: "Tool Handling",
feature4: "Installation & Setup",

whyTitle: "Why Choose Our Assembly Service",

whyText:
"Our experienced movers carefully handle furniture assembly using professional tools and techniques to ensure safety and precision.",
...
equipmentTitle: "Professional Tools We Use",

equipment1Title: "Power Tools",
equipment1Text: "Professional electric tools for fast and precise assembly.",

equipment2Title: "Precision Setup",
equipment2Text: "Careful alignment and secure installation of furniture parts.",

equipment3Title: "Protective Equipment",
equipment3Text: "Safe handling with protective materials and modern equipment.",
},
...
assemblyServicePage: "Сборка мебели",

heroTitle: "Сборка и разборка мебели",

heroText:
"Наша команда профессионально разберёт и соберёт мебель для безопасного и удобного переезда.",

feature1: "Разборка мебели",
feature2: "Точная сборка",
feature3: "Сервис",
feature4: "Установка и настройка",

whyTitle: "Почему выбирают нашу сборку",

whyText:
"Наши специалисты аккуратно выполняют сборку мебели с использованием профессиональных инструментов и современных методов.",
...
equipmentText: "Оборудование",
equipmentTitle: "Инструменты для сборки",

equipment1Title: "Электроинструменты",
equipment1Text: "Профессиональные инструменты для быстрой и точной сборки.",

equipment2Title: "Точная установка",
equipment2Text: "Аккуратная установка и надёжная фиксация мебели.",

equipment3Title: "Защитное оборудование",
equipment3Text: "Безопасная работа с использованием современных материалов.",
}
...
{translations[lang].assemblyServicePage}
</p>
...
<Hammer size={28} className="text-blue-400" />
</div>
...
<div className="w-16 h-16 rounded-full bg-gradient-to-br from-blue-500/20 to-purple-500/20 border border-white/10 backdrop-blur-xl flex items-center justify-center">
<Drill size={28} className="text-blue-400" />
</div>
...
{translations[lang].equipmentText}
</p>
...
{translations[lang].equipment1Title}
</h3>

<p className="text-gray-400 leading-relaxed">
{translations[lang].equipment1Text}
</p>
...
<h3 className="text-2xl font-black mb-4">
{translations[lang].equipment2Title}
</h3>

<p className="text-gray-400 leading-relaxed">
{translations[lang].equipment2Text}
</p>
...
<h3 className="text-2xl font-black mb-4">
{translations[lang].equipment3Title}
</h3>

<p className="text-gray-400 leading-relaxed">
{translations[lang].equipment3Text}
</p>
